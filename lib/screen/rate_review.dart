                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Column(
                                                                            children: [
                                                                              Container(width: 70, height: 60, child: Image.asset("assets/Coins.png")),
                                                                              Text("Coins"),
                                                                              Text("10"),
                                                                              ConfettiWidget(confettiController: _controllerBottomCenter, blastDirection: -pi / 2, emissionFrequency: 0.01, numberOfParticles: 80, maxBlastForce: 100, minBlastForce: 80, shouldLoop: false, blastDirectionality: BlastDirectionality.explosive, gravity: 0.3),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                      ],
